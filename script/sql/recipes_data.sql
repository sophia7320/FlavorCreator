...
'期间一定要注意观察，防止糊锅',
'40', 2, 476,
'["川菜","下饭菜","麻辣","家常菜"]', 'special', 1, 0, 0, 0, 0);
...
'回锅肉过冷水晾凉后肉质会更紧致\n切记不要切厚了，不然很腻',
'40', 3, 997,
'["川菜","经典","下饭菜","家常菜"]', 'special', 1, 0, 0, 0, 0);
...
'腌制时间至少半小时入味更佳',
'60', 2, 2873,
'["湘菜","下饭菜","香辣","家常菜"]', 'special', 1, 0, 0, 0, 0);
